...
protocol WebLoadable: AnyObject {
    var state: YaamavaWebStatus { get set }
...
final class YaamavaWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: YaamavaWebStatus = .standby
...
extension YaamavaWebLoader: WKNavigationDelegate {
