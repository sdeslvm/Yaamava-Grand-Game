...
struct YaamavaWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: YaamavaWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> YaamavaWebCoordinator {
        YaamavaWebCoordinator { [weak loader] status in
